...
namespace SolarWatchTest
{
    ...
    public class SunsetControllerTest
    {
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsBadRequest_IfGeocodeProviderFails()
        {
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsBadRequest_IfGeocodeJsonIsNotValid()
        {
            ...
            var result = await _controller.GetSunsetTime(_dateInput, nonExistingCity, _tzidInput);
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsBadRequest_IfSolarTimeProviderFails()
        {
            _cityRepositoryMock.Setup(x => x.GetByName(_cityInput)).ReturnsAsync((City)null);
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsBadRequest_IfSolarTimeJsonIsNotValid()
        {
            ...
            var result = await _controller.GetSunsetTime(invalidDate, _cityInput, _tzidInput);
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsOkResult_IfEveryOperationWasSuccessful()
        {
            _cityRepositoryMock.Setup(x => x.GetByName(_cityInput)).ReturnsAsync((City)null);
            _geocodeProviderMock.Setup(x => x.GetGeocode(_cityInput)).ReturnsAsync(_geocodeData);
            _geocodeJsonProcessorMock.Setup(x => x.ProcessGeocodeInfo(_geocodeData, _cityInput)).Returns(_cityObject);
        ...
        [Test]
        public async Task GetSunsetTime_ReturnsOkResult_IfCityAndSolarTimeInfoWasFoundInDatabase()
        {
